...
common_items = [list(set(r[len(r)//2:]).intersection(set(r[:len(r)//2])))[0] for r in rucksacks]
...
common_items_in_groups = [list(set(e1).intersection(set(e2)).intersection(set(e3)))[0] for e1, e2, e3 in groups]
